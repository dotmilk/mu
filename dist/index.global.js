var mu=(()=>{var m=Object.defineProperty;var c=Object.getOwnPropertyDescriptor;var f=Object.getOwnPropertyNames;var b=Object.prototype.hasOwnProperty;var g=(r,e)=>{for(var n in e)m(r,n,{get:e[n],enumerable:!0})},x=(r,e,n,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let o of f(e))!b.call(r,o)&&o!==n&&m(r,o,{get:()=>e[o],enumerable:!(s=c(e,o))||s.enumerable});return r};var y=r=>x(m({},"__esModule",{value:!0}),r);var w={};g(w,{MU_CSS:()=>p,MuTagen:()=>h,muCss:()=>l,muDom:()=>u});function l(r,e){let n=document.createElement("style");e&&(n.id=e),n.innerHTML=r,document.body.appendChild(n)}var p=`
